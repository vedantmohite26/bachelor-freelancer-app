...
class UserService {
  ...
  // In-memory cache for user profiles to prevent redundant network requests
  // Caching the Future itself allows multiple concurrent callers to share the same request
  ...
  // Get user profile - Optimized with in-memory Future caching
