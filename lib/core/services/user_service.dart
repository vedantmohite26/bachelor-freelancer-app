...
class UserService {
  ...
  // In-memory cache for user profiles to prevent redundant Firestore calls.
  // Storing the Future itself allows multiple concurrent callers to wait for
  // the same request instance, preventing "cache stampedes".
