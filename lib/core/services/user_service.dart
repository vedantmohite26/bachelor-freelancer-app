...
class UserService {
  ...
  // In-memory cache for user profile futures to prevent redundant network calls
  // and "cache stampedes" during list rendering (e.g., in reviews).
  ...
  Future<Map<String, dynamic>?> getUserProfile(String userId) async {
    ...
    // Otherwise, create a new request and cache the Future
