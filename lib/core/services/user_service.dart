...
class UserService {
  ...
  /// during rapid UI rebuilds (e.g., in a list of reviews).
  ...
  Future<Map<String, dynamic>?> getUserProfile(String userId) {
    ...
    // Return cached future if it exists to prevent "cache stampedes"
    // and redundant network requests during UI builds.
