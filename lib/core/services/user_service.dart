...
class UserService {
  ...
  // Cache for user profiles to avoid redundant Firestore fetches
  final Map<String, Future<Map<String, dynamic>?>> _profileCache = {};
  static const int _maxCacheSize = 100;

  /// Invalidates the cache for a specific user.
  /// Should be called after any profile-modifying operation.
  ...
  // Get user profile with in-memory Future caching
  Future<Map<String, dynamic>?> getUserProfile(String userId) {
    ...
    // Implement FIFO cache management
