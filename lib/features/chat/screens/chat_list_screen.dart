...
// ⚡ Optimization: _ChatListItem is converted to a StatefulWidget to cache
// the user profile Future in state across parent rebuilds (e.g. when last message
// timestamp updates or stream fires), avoiding redundant Future reinstantiations inside FutureBuilder.
...
class _ChatListItemState extends State<_ChatListItem> {
  ...
  void initState() {
    ...
    _userProfileFuture = Provider.of<UserService>(
      context,
      listen: false,
    ).getUserProfile(_otherUserId);
  }
  ...
  void didUpdateWidget(covariant _ChatListItem oldWidget) {
    ...
    final newOtherUserId = _getOtherUserId();
