...
class _ChatListItemState extends State<_ChatListItem> {
  ...
  void didUpdateWidget(covariant _ChatListItem oldWidget) {
    ...
    final newOtherUserId = widget.participants.firstWhere(
  ...
  void _fetchUserProfile() {
    ...
    // Performance optimization: Cache the user profile Future in state
    // so FutureBuilder does not re-instantiate or re-trigger on parent/stream updates.
