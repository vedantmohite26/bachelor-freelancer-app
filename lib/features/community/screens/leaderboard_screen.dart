...
class _LeaderboardScreenState extends State<LeaderboardScreen>
  ...
  Widget _buildGlobalLeaderboard() {
    final theme = Theme.of(context);
    // Bolt: Fetch currentUserId once outside the builder to avoid redundant lookups
    ...
    return StreamBuilder<List<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        // Bolt: Replaced SingleChildScrollView + Column + ListView(shrinkWrap: true)
        // with CustomScrollView + SliverList to enable virtualization for better performance.
        return CustomScrollView(
          slivers: [
            ...
            // List (Rank 4+) - Using DecoratedSliver for the background styling
            DecoratedSliver(
