      ...
      builder: (context, snapshot) {
        ...
        return CustomScrollView(
          ...
          slivers: [
            ...
            // List (Rank 4+)
            // PERFORMANCE OPTIMIZATION: Replacing SingleChildScrollView + shrinkWrap ListView
            // with CustomScrollView + SliverList enables "virtualization".
            // Only items visible on screen are rendered, reducing memory and build time from O(N) to O(visible).
            DecoratedSliver(
