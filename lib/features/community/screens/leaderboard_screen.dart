  ...
  Widget _buildGlobalLeaderboard() {
    ...
    return StreamBuilder<List<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        // Optimization: Fetch currentUserId once outside the builder to avoid redundant lookups
        final currentUserId =
            Provider.of<AuthService>(context, listen: false).user?.uid;

        // Optimization: Use CustomScrollView with virtualized slivers instead of SingleChildScrollView + shrinkWrap'd ListView
        // This ensures only visible items are built and laid out, improving performance for long lists.
