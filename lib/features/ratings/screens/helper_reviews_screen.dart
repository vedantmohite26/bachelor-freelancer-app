...
class HelperReviewsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Optimized with CustomScrollView and SliverList for virtualization
      body: CustomScrollView(
        slivers: [
          ...
          // Reviews List - StreamBuilder integrated as a sliver
          StreamBuilder<List<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              // Using SliverList for efficient O(visible) rendering
