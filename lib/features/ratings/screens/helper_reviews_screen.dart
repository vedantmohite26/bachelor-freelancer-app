  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        // PERFORMANCE: Using CustomScrollView with slivers enables virtualization.
        // Previously, SingleChildScrollView + ListView(shrinkWrap: true) rendered all items at once (O(N)).
        // Now, items are rendered lazily as they enter the viewport (O(visible)).
        slivers: [
          // Summary Section
          SliverToBoxAdapter(
            child: Column(
