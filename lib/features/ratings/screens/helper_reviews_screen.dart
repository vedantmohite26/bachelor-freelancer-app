  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        // PERFORMANCE: Using CustomScrollView with SliverList enables virtualization.
        // This ensures that ReviewCard widgets are only built and rendered when they
        // enter the viewport, significantly reducing initial build time and memory
        // usage for long lists of reviews (O(visible) instead of O(N)).
        slivers: [
          // Summary Section
          SliverToBoxAdapter(
