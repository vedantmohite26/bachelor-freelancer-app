    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          // PERFORMANCE OPTIMIZATION: Using CustomScrollView and SliverList.builder instead of
          // SingleChildScrollView + ListView(shrinkWrap: true).
          // This enables virtualization, meaning Flutter only builds the widgets currently
          // visible on screen. This significantly reduces memory usage and layout time (O(M) vs O(N)).
          return CustomScrollView(
            slivers: [
              ...
              // Reviews List or Loading/Error/Empty States
