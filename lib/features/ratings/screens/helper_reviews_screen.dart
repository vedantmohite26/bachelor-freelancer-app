...
class _HelperReviewsScreenState extends State<HelperReviewsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Reviews'), centerTitle: true, elevation: 0),
      // ⚡ OPTIMIZATION: Using CustomScrollView with SliverList for virtualization.
      // This improves performance from O(N) to O(visible) for list rendering.
        ...
        builder: (context, snapshot) {
          ...
          return CustomScrollView(
            slivers: [
              ...
              // Handle loading/error/empty states as slivers to keep summary visible
              if (snapshot.connectionState == ConnectionState.waiting)
                ...
                // Reviews List with virtualization enabled
                SliverPadding(
