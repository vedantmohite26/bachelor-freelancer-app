    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          // ⚡ Bolt Optimization: Using CustomScrollView with SliverList instead of
          // SingleChildScrollView + ListView(shrinkWrap: true).
          // This enables list virtualization, reducing initial build time from O(N) to O(visible)
          // and significantly lowering memory usage for long lists of reviews.
