...
class HelperReviewsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // ⚡ BOLT OPTIMIZATION: Replaced SingleChildScrollView + Column + ListView(shrinkWrap: true)
      // with CustomScrollView and SliverList. This enables list virtualization, reducing
      // memory footprint and build time from O(N) to O(visible).
        ...
        builder: (context, snapshot) {
          return CustomScrollView(
            slivers: [
              ...
              ..._buildSlivers(context, snapshot),
            ],
          );
        },
      ),
