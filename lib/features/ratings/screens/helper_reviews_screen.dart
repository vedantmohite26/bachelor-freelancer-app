    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          // ⚡ Bolt Optimization: Use CustomScrollView with slivers for virtualization.
          // This replaces the SingleChildScrollView + Column + ListView.builder(shrinkWrap: true) pattern.
          // Impact: Reduces initial build time and memory usage from O(N) to O(visible items).
          return CustomScrollView(
            slivers: [
              // 1. Summary Section (Fixed header)
              SliverToBoxAdapter(
              ...
              // 2. Content Section (Loading / Error / Empty / List)
