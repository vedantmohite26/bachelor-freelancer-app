        ...
        slivers: [
          ...
          StreamBuilder<List<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              // Optimization: Use SliverList for UI virtualization.
              // This ensures that ReviewCard items (which may contain heavy widgets like FutureBuilders)
              // are only built when they are visible on screen.
