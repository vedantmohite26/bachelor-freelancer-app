...
class _ReviewCardState extends State<ReviewCard> {
  ...
  void didUpdateWidget(ReviewCard oldWidget) {
    ...
    // Refresh future only if the seekerId has changed
    if (oldWidget.review['seekerId'] != widget.review['seekerId']) {
      _fetchUserProfile();
    }
  }
  ...
  void _fetchUserProfile() {
    ...
    if (seekerId.isNotEmpty) {
      // Bolt: Cache the future to avoid redundant Firestore calls on rebuilds
      _userProfileFuture =
          Provider.of<UserService>(context, listen: false).getUserProfile(
            seekerId,
          );
    } else {
