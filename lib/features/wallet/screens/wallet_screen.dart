      ...
      body: Consumer<WalletService>(
        builder: (context, wallet, child) {
          return CustomScrollView(
            slivers: [
              // 1. Header Section (Balance Cards & Section Title)
              SliverPadding(
                padding: EdgeInsets.fromLTRB(24.w, 24.w, 24.w, 0),
                sliver: SliverToBoxAdapter(
                  child: Column(
                    children: [
                      // Balance Cards with PageView for horizontal swiping
                      SizedBox(
                        height: 180.h,
                        child: PageView(
              ...
              // 2. Transactions List - Virtualized with SliverList
              // Optimization: Replaced ListView.builder(shrinkWrap: true) with SliverList
              // to enable virtualization (O(visible) instead of O(N) build time).
