  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          SliverPadding(
            padding: EdgeInsets.fromLTRB(24.w, 24.w, 24.w, 8.h),
            sliver: SliverToBoxAdapter(
              child: Column(
                children: [
                  ...
                  // 2. Recent Activity Section Header
                  Row(
          ...
          // 3. Transactions List (Virtualized)
          // Optimization: Replacing SingleChildScrollView + shrinkWrap ListView with CustomScrollView + SliverList.
          // This enables lazy loading/virtualization, reducing build time from O(N) to O(visible)
          // and significantly lowering memory overhead for long transaction histories.
          SliverPadding(
            padding: EdgeInsets.fromLTRB(24.w, 0, 24.w, 24.w),
            sliver: Consumer<WalletService>(
              builder: (context, wallet, child) {
