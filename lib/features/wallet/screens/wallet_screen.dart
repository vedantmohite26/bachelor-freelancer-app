      ...
      body: Consumer<WalletService>(
        builder: (context, wallet, child) {
          return CustomScrollView(
            slivers: [
              // Use SliverPadding to maintain overall screen padding
              SliverPadding(
                      ...
                      SizedBox(
                        ...
                        child: PageView(
                          ...
                          children: [
                            ...
                            // Removed SizedBox(width: 16.w) because _BalanceCard already has right margin
                            // and extra children in PageView cause unintended empty pages.
                            _BalanceCard(
                              title: "Student Coins",
              ...
              // 3. Transactions List (Virtualized with SliverList)
