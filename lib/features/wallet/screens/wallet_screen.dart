  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          // 1. Balance Cards and Recent Activity Header wrapped in a single SliverToBoxAdapter
          SliverPadding(
          ...
          // 2. Transactions dynamic list with SliverList virtualization
          ...
          // 3. Bottom spacing for lists/FAB layout support
          SliverToBoxAdapter(
