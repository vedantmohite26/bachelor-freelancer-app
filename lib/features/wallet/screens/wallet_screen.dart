...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // ⚡ Bolt Optimization: Use CustomScrollView + SliverList for virtualization
      // Replaced SingleChildScrollView + Column + ListView.builder (shrinkWrap: true)
      // which was O(N) rendering. Now O(visible) rendering for transactions.
